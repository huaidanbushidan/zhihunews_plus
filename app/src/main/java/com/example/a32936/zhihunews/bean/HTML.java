...
public class HTML {
         ...
         * 生成完整的HTML文档
         */
        public static String createHtmlData(String html, String cssList, String jsList) {
            final String css = HTML.createCssTag(cssList);
            final String js = HTML.createJsTag(jsList);
